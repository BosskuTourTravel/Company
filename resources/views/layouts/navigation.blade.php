...
<nav class="bg-[#02335B] py-3 px-6 fixed top-0 left-0 w-full z-50">
    <div class="container mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center">
            <a href="/"><img src="{{ asset('img/LogoWeb.png') }}" alt="Logo" class="h-10"></a>
        </div>
        ...
        <div class="hidden md:flex space-x-4 lg:space-x-6 text-white text-sm md:text-base">
            ...
            <a href="Tentang-Kami" class="relative group font-semibold">Tentang Kami
                <span class="absolute left-0 bottom-0 w-0 h-[2px] bg-white transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="Produk" class="relative group font-semibold">Produk
                <span class="absolute left-0 bottom-0 w-0 h-[2px] bg-white transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="FAQ" class="relative group font-semibold">FAQ
                <span class="absolute left-0 bottom-0 w-0 h-[2px] bg-white transition-all duration-300 group-hover:w-full"></span>
            </a>
        </div>
        ...
        <div class="flex space-x-2 md:space-x-3 lg:space-x-4">
            <a href="login" class="bg-white text-[#02335B] font-bold px-3 py-1 md:px-5 md:py-2 rounded-lg hover:bg-white hover:text-[#02335B] transition duration-300 flex items-center justify-center text-xs md:text-sm lg:text-base">
                Masuk
            </a>
            <a href="register" class="bg-[#FFCA10] text-[#02335B] font-bold px-3 py-1 md:px-5 md:py-2 rounded-lg hover:bg-white hover:text-[#02335B] transition duration-300 flex items-center justify-center text-xs md:text-sm lg:text-base">
                Daftar
            </a>
        </div>
...
<nav class="bg-[#02335B] py-3 fixed bottom-0 left-0 w-full flex sm:hidden z-50">
    <div class="container mx-auto flex justify-around text-white">
        ...
        <!-- Ikon Tentang Kami -->
        <a href="Tentang-Kami" class="flex flex-col items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <!-- Ikon Produk -->
        <a href="Produk" class="flex flex-col items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
