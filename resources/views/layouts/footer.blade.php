    ...
    <div class="container mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div>
            ...
            <ul class="space-y-1 text-sm text-gray-300">
                ...
                <li><a href="#" class="hover:text-gray-400">Kebijakan Privasi</a></li>
                <li><a href="#" class="hover:text-gray-400">Syarat & Ketentuan</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <div class="flex space-x-3">
                ...
                <a href="#" class="hover:text-gray-400">
                    <svg class="w-5 h-5" fill="#ffffff" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                ...
                <a href="#" class="hover:text-gray-400">
                    <svg class="w-5 h-5" fill="#ffffff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
